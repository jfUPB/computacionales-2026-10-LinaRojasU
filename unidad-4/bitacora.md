...
#### Diagrama 1 Almacenamiento en memoria de un nodo simple.


#### Diagrama 2 Inserción al final.

#### Diagrama 3 Eliminación del primer nodo.

#### Diagrama 4 Almacenamiento en memoria: cola FIFO.

#### Diagrama 5 Enqueue + control maxSize.

#### Diagrama 6 Opacidad gradual y relación con la aplicación creativa.
